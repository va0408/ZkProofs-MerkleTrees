...
for (const [name, input] of Object.entries(cases)) {
  ...
  try {
    ...
    execSync(`node build_suma_modular/generate_witness.js build_suma_modular/suma_modular.wasm input.json witness_${name}.wtns`, { stdio: "inherit" });
    ...
    execSync(`snarkjs groth16 verify verification_key_suma_modular.json public_${name}.json proof_${name}.json`, { stdio: "inherit" });
